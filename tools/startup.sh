...
# mongo/zookeeper/kafka(msg)  demo:i-ec2eafdc  qa:i-8567c993  uat:i-6925ccf1
...
case $ENVIRONMENT in
    demo)
        ...
        ;;
    qa)
        STARTFIRST=( "i-8567c993" "i-75b63363" )
...
do
    aws ec2 start-instances --instance-ids ${ec2instance}
    sleep 45
done

# Start all of the rest
aws ec2 start-instances --instance-ids ${STARTTOGETHER}