#!/bin/bash
export HomeDir=${HOME}
export OpsDeckPath="$HomeDir/OpsDeck"
echo "++++++++++++++++++++++++++++++++++++++++++++++"
echo "          Refreshing OpsDeck                  "
echo "++++++++++++++++++++++++++++++++++++++++++++++"
~/get_ops.sh
...
function check_if_image_exists(){
  ...
  array[gccloud/storm]="sudo docker build -t=gccloud/storm --no-cache $OpsDeckPath/gccloud-storm/."
...
check_if_image_exists gccloud/storm
