...
public class STRAXUasStepDefinition {
	...
	public void user_enters_valid_values_for_following_UAS_fields(Map<String, String> tableData)
			throws InterruptedException {
		System.out.println(".........in straxuas");
		uasPage.addNewUAS(tableData.get("Name"), tableData.get("Feed"), tableData.get("Make"),
				tableData.get("SerialNumber"), tableData.get("Model"), tableData.get("Status"), tableData.get("Type"));
	}
