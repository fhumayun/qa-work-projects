...
public class STRAXVideoFeedsStepDefinition {
	...
	public void Clicks_on_Add_new_button_and_enter_details_for_following_fields(Map<String, String> tableData)
			throws Exception {
		vfPage.addNewUAV(tableData.get("Name"), tableData.get("Account"), tableData.get("CameraType"),
				tableData.get("WowzaPort"), tableData.get("KlvPort"), tableData.get("FrameRate"),
				tableData.get("FeedVideo"));
	...
	public void enter_details_for_following_fields_to_update_the_feed(Map<String, String> tableData) throws Exception {
		...
		vfPage.updateFeed(tableData.get("Name"), tableData.get("Account"), tableData.get("CameraType"),
				tableData.get("WowzaPort"), tableData.get("KlvPort"), tableData.get("FrameRate"),
				tableData.get("FeedVideo"));
	}
