...
Examples:
	...
	|autobot@ee.io|eei|AutomationTestIncident|Search & Rescue|red.stream|1001 Broken Sound Parkway NW|Suite C|33487|Boca Raton|FLORIDA|||Event Created By Automation Framework|User Controller, User Viewer,EEiUser User|
@C44556 @SRM @Event
...
Examples:
	...
	|autobot@ee.io|eei|AutomationTestIncident|
	|controller@ee.io|eei|AutomationTestIncident|
	|user@ee.io|eei|AutomationTestIncident|
	|viewer@ee.io|eei|AutomationTestIncident|
@C44558 @SRM @Event
